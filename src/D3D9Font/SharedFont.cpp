...
void SharedFont::Initialize()
{
	...
	// Create a font.  By specifying ANTIALIASED_QUALITY, we might get an antialiased font, but this is not guaranteed.
	INT nHeight = -MulDiv(m_height, (INT)(GetDeviceCaps(hDC, LOGPIXELSY)), 72);
